import type { OpenAI } from './ai';
import { chat, chatJSON, synthesize, transcribe } from './ai';
import { analyzeConversation } from './analysis';
import { detectCodeSwitches } from './code-switch-detector';
import { trackUsage } from './cost-tracker';
import { appendMessage, createConversation, getConversationById } from './data/conversations';
...
import { testLanguagePair } from './language-tester';
import { generateLessonPlan } from './lessons';
import { buildTutorSystemPrompt } from './prompts/tutor';
import { translatePromptSections } from './prompts/translate-prompt';
import { evaluatePronunciation } from './pronunciation';
import { detectToneErrors } from './tones';
import type {
	AIService,
...
import type { CefrLevel, TranscriptionResult } from '@linguist/ai-core';
...
function toModelMessages(
	...
	const modelMessages: OpenAI.ChatCompletionMessageParam[] = [{ role: 'system', content: systemPrompt }];
